...
export function TokenUsageCard({
  ...
  return (
    <div className="rounded-lg border border-gray-200 bg-gray-50 p-4 dark:border-zinc-800 dark:bg-zinc-900">
      <h3 className="mb-3 text-sm font-medium text-gray-500 dark:text-zinc-400">{title}</h3>
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          ...
          <div className="text-xs text-gray-500 dark:text-zinc-500">Total Tokens</div>
        </div>
        ...
        <div>
          ...
          <div className="text-xs text-gray-500 dark:text-zinc-500">API Equivalent</div>
        </div>
      </div>
      ...
      {showDetails && (
        <div className="mt-4 space-y-2 border-t border-gray-200 pt-4 dark:border-zinc-800">
          <div className="flex justify-between text-sm">
            <span className="text-gray-500 dark:text-zinc-400">Input</span>
            <span className="text-gray-900 dark:text-white">
              {formatTokenCount(usage.inputTokens)}
            </span>
          </div>
          <div className="flex justify-between text-sm">
            <span className="text-gray-500 dark:text-zinc-400">Output</span>
            <span className="text-gray-900 dark:text-white">
          ...
          {usage.cacheCreationInputTokens > 0 && (
            <div className="flex justify-between text-sm">
              <span className="text-gray-500 dark:text-zinc-400">Cache Creation</span>
          ...
          {usage.cacheReadInputTokens > 0 && (
            <div className="flex justify-between text-sm">
              <span className="text-gray-500 dark:text-zinc-400">Cache Read</span>
          ...
          return (
            ...
            >
              ...
              <div className="absolute bottom-full z-10 mb-2 hidden group-hover:block">
                <div className="whitespace-nowrap rounded bg-gray-800 px-2 py-1 text-xs text-white dark:bg-zinc-800">
                  ...
                  <div className="text-gray-400">{day.sessionCount} sessions</div>
                </div>
              </div>
            </div>
          );
  ...
  return (
    <div className="rounded-lg border border-gray-200 bg-gray-50 dark:border-zinc-800 dark:bg-zinc-900">
      <div className="border-b border-gray-200 p-4 dark:border-zinc-800">
        <h3 className="text-sm font-medium text-gray-500 dark:text-zinc-400">Recent Sessions</h3>
      </div>
        ...
        {displaySessions.map((session) => {
          ...
          return (
            <div
              ...
              className="p-3 hover:bg-gray-100 dark:hover:bg-zinc-800/50"
            >
      ...
      {sessions.length > maxItems && (
        <div className="border-t border-gray-200 p-3 text-center text-xs text-gray-500 dark:border-zinc-800 dark:text-zinc-500">
